...
let
  ...
  inherit (roleFlags) enableSteam enableMullvadVpn enableLibvirtd enableDocker enableFlatpak dockerMode useRootlessDocker useRootfulDocker;
in
{
  assertions = [
    {
  ...
  services = {
    ...
    resolved.enable = enableMullvadVpn;
